...
Map<String, dynamic> _$LopScheduleToJson(LopSchedule instance) =>
    <String, dynamic>{
      ...
      if (instance.lopScheduleID case final value?) 'scheduleID': value,
      if (zzz_date2Str(instance.startTime) case final value?)
        'startTime': value,
      if (zzz_date2Str(instance.endTime) case final value?) 'endTime': value,
      if (instance.lopScheduleStatus case final value?) 'scheduleStatus': value,
      if (instance.externalLink case final value?) 'externalLink': value,
    };
