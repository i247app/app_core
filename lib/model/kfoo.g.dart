...
Map<String, dynamic> _$KFooToJson(KFoo instance) => <String, dynamic>{
      ...
      if (zzz_list2Str(instance.datas) case final value?) 'datas': value,
      if (instance.fooStatus case final value?) 'fooStatus': value,
    };
