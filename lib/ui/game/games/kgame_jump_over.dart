...
class KGameJumpOver extends StatefulWidget {
  ...
  @override
  _KGameJumpOverState createState() => _KGameJumpOverState();
}

class _KGameJumpOverState extends State<KGameJumpOver>
  ...
  void checkResult() {
    if (isScroll) {
      for (int i = 0; i < barrierX.length; i++) {
        ...
        double bottomBarrier = 0;
        double topBarrier = -_barrierHeight;
