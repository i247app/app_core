...
class CrossLeftToRightImage extends StatefulWidget {
  final List<String> imageUrls;
  final KImageAnimationParameters? animationPreset;

  const CrossLeftToRightImage(this.imageUrls, {this.animationPreset});

  @override
  _CrossLeftToRightImageState createState() => _CrossLeftToRightImageState();
}

class _CrossLeftToRightImageState extends State<CrossLeftToRightImage>
