...
class TinyZoomShakeImage extends StatefulWidget {
  final List<String> imageUrls;
  final KImageAnimationParameters? animationPreset;

  const TinyZoomShakeImage(this.imageUrls, {this.animationPreset});

  @override
  _TinyZoomShakeImageState createState() => _TinyZoomShakeImageState();
}

class _TinyZoomShakeImageState extends State<TinyZoomShakeImage>
    with TickerProviderStateMixin {
  late Animation _shakeAnimation;
  late Animation<double> _scaleAnimation, _scaleAnimationNormal;
  ...
  void initState() {
    ...
    _scaleAnimation = new Tween(
      begin: 0.4,
        ...
        parent: _scaleAnimationController, curve: Curves.bounceIn));
    _scaleAnimationNormal = new Tween(
      begin: 1.0,
      end: 2.0,
    ).animate(new CurvedAnimation(
          ...
          children: [
            Align(
              ...
              child: ScaleTransition(
                scale: !isScaled ? _scaleAnimation : _scaleAnimationNormal,
                child: Transform(
