...
class CrossLeftToRightJumperImage extends StatefulWidget {
  final List<String> imageUrls;
  final KImageAnimationParameters? animationPreset;

  const CrossLeftToRightJumperImage(this.imageUrls, {this.animationPreset});

  @override
  _CrossLeftToRightJumperImageState createState() =>
      _CrossLeftToRightJumperImageState();
}

class _CrossLeftToRightJumperImageState
    extends State<CrossLeftToRightJumperImage> with TickerProviderStateMixin {
  ...
  void executeAnimation() {
    ...
    Future.delayed(Duration(milliseconds: 700 + Random().nextInt(600)), () {
      if (mounted) this._jumpAnimationController.forward();
    });
  }
