...
class KEggHatchIntro extends StatefulWidget {
  final VoidCallback? onFinish;

  const KEggHatchIntro({this.onFinish});

  @override
  _KEggHatchIntroState createState() => _KEggHatchIntroState();
}

class _KEggHatchIntroState extends State<KEggHatchIntro>
      ...
      child: this.eggBreakStep == 1
          ? Transform.scale(
              ...
              child: KImageAnimation(
                ...
                imageUrls: [
                  "https://pix1.s3.us-west-1.amazonaws.com/hero/tamago_01.png"
                ],
                maxLoop: 2,
                onFinish: () {
                  this.setState(() {
      ...
      child: this.eggBreakStep == 2
          ? Transform.scale(
              ...
              child: KImageAnimation(
                animationType: KImageAnimationType.SHAKE_THE_TOP,
                imageUrls: [
                  "https://pix1.s3.us-west-1.amazonaws.com/hero/tamago_02.png"
                ],
                maxLoop: 3,
                onFinish: () {
                  this.setState(() {
      ...
      child: this.eggBreakStep == 3
          ? Transform.scale(
              ...
              child: KImageAnimation(
                animationType: KImageAnimationType.SHAKE_THE_TOP,
                imageUrls: [
                  "https://pix1.s3.us-west-1.amazonaws.com/hero/tamago_03.png"
                ],
                maxLoop: 2,
                onFinish: () {
                  this.setState(() {
    ...
    final eggStep4 = AnimatedOpacity(
      ...
      child: this.eggBreakStep == 4
          ? Transform.scale(
              scale: 0.5,
              child: Image.network(
                "https://pix1.s3.us-west-1.amazonaws.com/hero/tamago_04.png",
                errorBuilder: (context, error, stack) => Container(),
              ),
            )
          : Container(),
